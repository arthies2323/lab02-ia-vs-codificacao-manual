...
| gabriel | sem-ia | 2026-09-17 | 35.0000 | true | sem captura do cronômetro (relatado pelo grupo); duração real estimada em ~42 min, por comparação com o trial do arthur (mesmo kata, +2 min) |
| gabriel | com-ia | 2026-09-17 | 4.9167 | false | Claude Code (Claude Opus 5); 9/9 testes |
...
python scripts/collect_static_metrics.py \
  --path katas/agenda-turnos/solucoes/<integrante>/<tratamento> \
  --kata agenda-turnos \
